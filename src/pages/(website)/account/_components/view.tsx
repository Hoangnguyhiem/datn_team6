...
const ViewAccount = (props: Props) => {
    ...
    const status = [{ id: 1, name: "Tất cả", }, { id: 2, name: "Chưa thanh toán", }, { id: 3, name: "Chờ vận chuyển", }, { id: 4, name: "Đã vận chuyển", }, { id: 5, name: "Cần đánh giá", }, { id: 6, name: "Trả hàng", }]
                                                ...
                                                <div className='w-[100%] flex'>
                                                    ...
                                                    <div className="w-[calc(100%-120px)] pl-[16px] flex items-center">
                                                        ...
                                                        {item.status_bill === "delivered" ? (
                                                            <div className="">
                                                                <div onClick={() => { setCommentEvaluate(!isCommentEvaluate), setItemProduct(value) }} className=" cursor-pointer rounded-[3px] text-center w-[80px] py-[4px] border-[1px] border-[#B01722] mb-[5px] text-[#B01722]">Đánh giá</div>
